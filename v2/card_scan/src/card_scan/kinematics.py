...
for the full explanation of ArmParams' fields. card_scan never fits
kinematics itself; it reads a previously-fitted ArmParams via
kinematics_read.py (falling back to CAD-nominal values, with a loud
warning, if none exists yet)."""
