...
from card_scan.kinematics_read import load_params


def test_load_params_warns_and_falls_back_to_nominal_when_no_fit_exists(tmp_path):
    with pytest.warns(UserWarning, match="CAD-nominal"):
